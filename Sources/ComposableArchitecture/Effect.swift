...
/// * If using ReactiveSwift in your application, in particular the dependencies of your feature's
/// environment, then you can create effects by making use of ReactiveSwift's `SignalProducer`s.
/// Note that the ReactiveSwift interface to ``Effect`` is considered soft deprecated, and you
/// should eventually port to Swift's native concurrency tools.
///
